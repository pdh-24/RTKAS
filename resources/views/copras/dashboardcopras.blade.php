...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="home-tab">
                    <h1 class="welcome-heading">SELAMAT DATANG, <span class="text-black fw-bold">USER</span></h1>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body" style="background-color: #b9dfbd;">
                        <div class="d-sm-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h5 class="card-subtitle mb-4">INI ADALAH DASHBOARD SPK METODE COPRAS</h5>
                            </div>
                        </div>
